...
<body>
    ...
    <div class="contain py-16">
        <div class="max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden">
            <h2 class="text-2xl uppercase font-medium mb-1">Home Accessories </h2>
            <p class="text-gray-600 mb-6 text-sm">
                Fill below
                    ...
                    <label for="number_of_pieces">Number Of Pieces:</label><br>
                    <input type="number" name="number_of_pieces" id="number_of_pieces" ><br><br>
                    ...
                    <label for="city">City:</label><br>
                            ...
                            <input type="file" accept="application/png,.jpg" id="images" name="images">
